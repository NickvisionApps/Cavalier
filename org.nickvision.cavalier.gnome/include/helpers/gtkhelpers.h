...
namespace Nickvision::Cavalier::GNOME::Helpers::GtkHelpers
{
    /**
     ...
     * @param allowEllipse Whether or not to allow ellipses in the combo row
     */
    void setComboRowModel(AdwComboRow* row, const std::vector<std::string>& strs, size_t selected = 0, bool allowEllipse = true);
}
