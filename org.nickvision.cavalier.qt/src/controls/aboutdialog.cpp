...
namespace Nickvision::Cavalier::Qt::Controls
{
        ...
        m_ui{ new Ui::AboutDialog() }
    {
        ...
        //Load
        m_ui->lblIcon->setPixmap({ appInfo.getVersion().getVersionType() == VersionType::Stable ? ":/resources/org.nickvision.cavalier.svg" : ":/resources/org.nickvision.cavalier-devel.svg" });
