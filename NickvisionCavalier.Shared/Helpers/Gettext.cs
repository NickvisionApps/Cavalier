...
namespace NickvisionCavalier.Shared.Helpers;

public static class Gettext
{
    private static readonly ICatalog _catalog = new Catalog("cavalier", Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location));
